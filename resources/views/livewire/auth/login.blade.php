                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" wire:submit="login()">
                        ...
                        <div class="fv-row mb-10">
                            <x-label for="email" value="{{ __('messages.login.email') }}" />
                            <x-input type="text" name="email" :value="old('email')" wire:model="email" autofocus autocomplete="email" />
                        ...
                        <div class="fv-row mb-10">
                            <div class="d-flex flex-stack mb-2">
                                <x-label for="password" value="{{ __('messages.login.password') }}" />
                            </div>
                            <x-input type="password" name="password" wire:model="password" :value="old('password')" autocomplete="password" />
